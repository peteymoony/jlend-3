import{B as e,H as t,N as n,S as r,b as i,h as a,r as o,rt as s,v as c}from"./ApiController-DawsP2Pt.js";import{c as l,f as u,o as d,r as f,t as p}from"./exports-GL0dN1cC.js";import{l as m,o as h,u as g}from"./wui-text-DJQj4kCs.js";import{t as _}from"./SwapController-YzuM87Dl.js";import"./w3m-tooltip-Bb6Q4z7k.js";import{t as v}from"./MathUtil-B2UslVSw.js";import"./wui-button-dVZ2TtBR.js";import"./wui-icon-MccyGakm.js";import"./wui-image-lz3O9nL3.js";import"./wui-shimmer-LDXP7S55.js";import"./wui-shimmer-DFka5QEZ.js";import"./wui-icon-box-B2M43lNJ.js";import"./wui-input-text-CyjFmlkG.js";import"./wui-token-button-bGKvcqrI.js";var y={numericInputKeyDown(e,t,n){let r=[`Backspace`,`Meta`,`Ctrl`,`a`,`A`,`c`,`C`,`x`,`X`,`v`,`V`,`ArrowLeft`,`ArrowRight`,`Tab`],i=e.metaKey||e.ctrlKey,a=e.key,o=a.toLocaleLowerCase(),s=o===`a`,c=o===`c`,l=o===`v`,u=o===`x`,d=a===`,`,f=a===`.`,p=a>=`0`&&a<=`9`;!i&&(s||c||l||u)&&e.preventDefault(),t===`0`&&!d&&!f&&a===`0`&&e.preventDefault(),t===`0`&&p&&(n(a),e.preventDefault()),(d||f)&&(t||(n(`0.`),e.preventDefault()),(t?.includes(`.`)||t?.includes(`,`))&&e.preventDefault()),!p&&!r.includes(a)&&!f&&!d&&e.preventDefault()}},b=d`
  :host {
    width: 100%;
  }
...
`,x=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},S=t.CONVERT_SLIPPAGE_TOLERANCE,C=class extends l{constructor(){super(),this.unsubscribe=[],this.networkName=o.state.activeCaipNetwork?.name,this.detailsOpen=!1,this.sourceToken=_.state.sourceToken,this.toToken=_.state.toToken,this.toTokenAmount=_.state.toTokenAmount,this.sourceTokenPriceInUSD=_.state.sourceTokenPriceInUSD,this.toTokenPriceInUSD=_.state.toTokenPriceInUSD,this.priceImpact=_.state.priceImpact,this.maxSlippage=_.state.maxSlippage,this.networkTokenSymbol=_.state.networkTokenSymbol,this.inputError=_.state.inputError,this.unsubscribe.push(_.subscribe(e=>{this.sourceToken=e.sourceToken,this.toToken=e.toToken,this.toTokenAmount=e.toTokenAmount,this.priceImpact=e.priceImpact,this.maxSlippage=e.maxSlippage,this.sourceTokenPriceInUSD=e.sourceTokenPriceInUSD,this.toTokenPriceInUSD=e.toTokenPriceInUSD,this.inputError=e.inputError}))}render(){let e=this.toTokenAmount&&this.maxSlippage?s.bigNumber(this.toTokenAmount).minus(this.maxSlippage).toString():null;if(!this.sourceToken||!this.toToken||this.inputError)return null;let t=this.sourceTokenPriceInUSD&&this.toTokenPriceInUSD?1/this.toTokenPriceInUSD*this.sourceTokenPriceInUSD:0;return u`
    ...
    `}toggleDetails(){this.detailsOpen=!this.detailsOpen}};C.styles=[b],x([m()],C.prototype,`networkName`,void 0),x([g()],C.prototype,`detailsOpen`,void 0),x([m()],C.prototype,`sourceToken`,void 0),x([m()],C.prototype,`toToken`,void 0),x([m()],C.prototype,`toTokenAmount`,void 0),x([m()],C.prototype,`sourceTokenPriceInUSD`,void 0),x([m()],C.prototype,`toTokenPriceInUSD`,void 0),x([m()],C.prototype,`priceImpact`,void 0),x([m()],C.prototype,`maxSlippage`,void 0),x([m()],C.prototype,`networkTokenSymbol`,void 0),x([m()],C.prototype,`inputError`,void 0),C=x([h(`w3m-swap-details`)],C);var w=d`
  :host {
    width: 100%;
  }
...
`,T=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},E=class extends l{constructor(){super(...arguments),this.target=`sourceToken`}render(){return u`
    ...
    `}};E.styles=[w],T([g()],E.prototype,`target`,void 0),E=T([h(`w3m-swap-input-skeleton`)],E);var D=d`
  :host > wui-flex {
    display: flex;
    flex-direction: row;
    justify-content: space-between;
...
`,O=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},k=5e-5,A=class extends l{constructor(){super(...arguments),this.focused=!1,this.price=0,this.target=`sourceToken`,this.onSetAmount=null,this.onSetMaxValue=null,this.autoFocus=!1}firstUpdated(){this.autoFocus&&requestAnimationFrame(()=>{(this.shadowRoot?.querySelector(`input`))?.focus()})}render(){let e=this.marketValue||`0`,t=s.bigNumber(e).gt(`0`);return u`
      <wui-flex
    ...
    `:u` <wui-button
      ...
      >
        Select token
      </wui-button>`}tokenBalanceTemplate(){let e=s.multiply(this.balance,this.price),t=e?e?.gt(k):!1;return u`
    ...
    </button>`}onFocusChange(e){this.focused=e}onSelectToken(){i.sendEvent({type:`track`,event:`CLICK_SELECT_TOKEN_TO_SWAP`}),r.push(`SwapSelectToken`,{target:this.target})}onBuyToken(){r.push(`OnRampProviders`)}};A.styles=[D],O([g()],A.prototype,`focused`,void 0),O([g()],A.prototype,`balance`,void 0),O([g()],A.prototype,`value`,void 0),O([g()],A.prototype,`price`,void 0),O([g()],A.prototype,`marketValue`,void 0),O([g()],A.prototype,`disabled`,void 0),O([g()],A.prototype,`target`,void 0),O([g()],A.prototype,`token`,void 0),O([g()],A.prototype,`onSetAmount`,void 0),O([g()],A.prototype,`onSetMaxValue`,void 0),O([g({type:Boolean})],A.prototype,`autoFocus`,void 0),A=O([h(`w3m-swap-input`)],A);var j=d`
...
`,M=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},N=class extends l{subscribe({resetSwapState:e,initializeSwapState:t}){return()=>{o.subscribeKey(`activeCaipNetwork`,n=>this.onCaipNetworkChange({newCaipNetwork:n,resetSwapState:e,initializeSwapState:t})),o.subscribeChainProp(`accountState`,n=>{this.onCaipAddressChange({newCaipAddress:n?.caipAddress,resetSwapState:e,initializeSwapState:t})})}}constructor(){super(),this.unsubscribe=[],this.initialParams=r.state.data?.swap,this.detailsOpen=!1,this.caipAddress=o.getAccountData()?.caipAddress,this.caipNetworkId=o.state.activeCaipNetwork?.caipNetworkId,this.initialized=_.state.initialized,this.loadingQuote=_.state.loadingQuote,this.loadingPrices=_.state.loadingPrices,this.loadingTransaction=_.state.loadingTransaction,this.sourceToken=_.state.sourceToken,this.sourceTokenAmount=_.state.sourceTokenAmount,this.sourceTokenPriceInUSD=_.state.sourceTokenPriceInUSD,this.toToken=_.state.toToken,this.toTokenAmount=_.state.toTokenAmount,this.toTokenPriceInUSD=_.state.toTokenPriceInUSD,this.inputError=_.state.inputError,this.fetchError=_.state.fetchError,this.lastTokenPriceUpdate=0,this.minTokenPriceUpdateInterval=1e4,this.visibilityChangeHandler=()=>{document?.hidden?(clearInterval(this.interval),this.interval=void 0):this.startTokenPriceInterval()},this.startTokenPriceInterval=()=>{this.interval&&Date.now()-this.lastTokenPriceUpdate<this.minTokenPriceUpdateInterval||(this.lastTokenPriceUpdate&&Date.now()-this.lastTokenPriceUpdate>this.minTokenPriceUpdateInterval&&this.fetchTokensAndValues(),clearInterval(this.interval),this.interval=setInterval(()=>{this.fetchTokensAndValues()},this.minTokenPriceUpdateInterval))},this.watchTokensAndValues=()=>{!this.sourceToken||!this.toToken||(this.subscribeToVisibilityChange(),this.startTokenPriceInterval())},this.onDebouncedGetSwapCalldata=e.debounce(async()=>{await _.swapTokens()},200),this.subscribe({resetSwapState:!0,initializeSwapState:!1})(),this.unsubscribe.push(this.subscribe({resetSwapState:!1,initializeSwapState:!0}),c.subscribeKey(`open`,e=>{e||_.resetState()}),r.subscribeKey(`view`,e=>{e.includes(`Swap`)||_.resetValues()}),_.subscribe(e=>{this.initialized=e.initialized,this.loadingQuote=e.loadingQuote,this.loadingPrices=e.loadingPrices,this.loadingTransaction=e.loadingTransaction,this.sourceToken=e.sourceToken,this.sourceTokenAmount=e.sourceTokenAmount,this.sourceTokenPriceInUSD=e.sourceTokenPriceInUSD,this.toToken=e.toToken,this.toTokenAmount=e.toTokenAmount,this.toTokenPriceInUSD=e.toTokenPriceInUSD,this.inputError=e.inputError,this.fetchError=e.fetchError,e.sourceToken&&e.toToken&&this.watchTokensAndValues()}))}async firstUpdated(){_.initializeState(),this.watchTokensAndValues(),await this.handleSwapParameters()}disconnectedCallback(){this.unsubscribe.forEach(e=>e?.()),clearInterval(this.interval),document?.removeEventListener(`visibilitychange`,this.visibilityChangeHandler)}render(){return u`
    ...
    `}templateTokenInput(e,t){let n=_.state.myTokensWithBalance?.find(e=>e?.address===t?.address),r=e===`toToken`?this.toTokenAmount:this.sourceTokenAmount,i=e===`toToken`?this.toTokenPriceInUSD:this.sourceTokenPriceInUSD,a=s.parseLocalStringToNumber(r)*i;return u`<w3m-swap-input
    ...
    ></w3m-swap-input>`}onSetMaxValue(e,t){let n=s.bigNumber(t||`0`);if(!n.gt(0)){this.handleChangeAmount(e,`0`);return}let r=e===`sourceToken`?this.sourceToken:this.toToken,i=r?.decimals??18,{networkAddress:a}=_.getParams(),o=_.state.gasFee;if(e===`sourceToken`&&r?.address===a&&o&&o!==`0`){let t=150000n*BigInt(o),r=s.bigNumber(t.toString()).div(s.bigNumber(10).pow(i)),a=n.minus(r);this.handleChangeAmount(e,a.gt(0)?a.toFixed(i,0):`0`)}else this.handleChangeAmount(e,n.toFixed(i,0))}templateDetails(){return!this.sourceToken||!this.toToken||this.inputError?null:u`<w3m-swap-details .detailsOpen=${this.detailsOpen}></w3m-swap-details>`}handleChangeAmount(e,t){_.clearError(),e===`sourceToken`?_.setSourceTokenAmount(t):_.setToTokenAmount(t),this.onDebouncedGetSwapCalldata()}templateActionButton(){let e=!this.toToken||!this.sourceToken,t=!this.sourceTokenAmount||this.sourceTokenAmount===`0`,n=this.loadingQuote||this.loadingPrices||this.loadingTransaction,r=n||e||t||this.inputError;return u` <wui-flex gap="2">
      <wui-button
    ...
    </wui-flex>`}async onSwitchTokens(){await _.switchTokens()}async onSwapPreview(){this.fetchError&&await _.swapTokens(),i.sendEvent({type:`track`,event:`INITIATE_SWAP`,properties:{network:this.caipNetworkId||``,swapFromToken:this.sourceToken?.symbol||``,swapToToken:this.toToken?.symbol||``,swapFromAmount:this.sourceTokenAmount||``,swapToAmount:this.toTokenAmount||``,isSmartAccount:a(o.state.activeChain)===n.ACCOUNT_TYPES.SMART_ACCOUNT}}),r.push(`SwapPreview`)}async handleSwapParameters(){this.initialParams&&(_.state.initialized||await new Promise(e=>{let t=_.subscribeKey(`initialized`,n=>{n&&(t?.(),e())})}),await this.setSwapParameters(this.initialParams))}async setSwapParameters({amount:e,fromToken:t,toToken:n}){(!_.state.tokens||!_.state.myTokensWithBalance)&&await new Promise(e=>{let t=_.subscribeKey(`myTokensWithBalance`,n=>{n&&n.length>0&&(t?.(),e())});setTimeout(()=>{t?.(),e()},5e3)});let r=[..._.state.tokens||[],..._.state.myTokensWithBalance||[]];if(t){let e=r.find(e=>e.symbol.toLowerCase()===t.toLowerCase());e&&_.setSourceToken(e)}if(n){let e=r.find(e=>e.symbol.toLowerCase()===n.toLowerCase());e&&_.setToToken(e)}e&&!isNaN(Number(e))&&_.setSourceTokenAmount(e)}onCaipAddressChange({newCaipAddress:e,resetSwapState:t,initializeSwapState:n}){this.caipAddress!==e&&(this.caipAddress=e,t&&_.resetState(),n&&_.initializeState())}onCaipNetworkChange({newCaipNetwork:e,resetSwapState:t,initializeSwapState:n}){this.caipNetworkId!==e?.caipNetworkId&&(this.caipNetworkId=e?.caipNetworkId,t&&_.resetState(),n&&_.initializeState())}};N.styles=j,M([g({type:Object})],N.prototype,`initialParams`,void 0),M([m()],N.prototype,`interval`,void 0),M([m()],N.prototype,`detailsOpen`,void 0),M([m()],N.prototype,`caipAddress`,void 0),M([m()],N.prototype,`caipNetworkId`,void 0),M([m()],N.prototype,`initialized`,void 0),M([m()],N.prototype,`loadingQuote`,void 0),M([m()],N.prototype,`loadingPrices`,void 0),M([m()],N.prototype,`loadingTransaction`,void 0),M([m()],N.prototype,`sourceToken`,void 0),M([m()],N.prototype,`sourceTokenAmount`,void 0),M([m()],N.prototype,`sourceTokenPriceInUSD`,void 0),M([m()],N.prototype,`toToken`,void 0),M([m()],N.prototype,`toTokenAmount`,void 0),M([m()],N.prototype,`toTokenPriceInUSD`,void 0),M([m()],N.prototype,`inputError`,void 0),M([m()],N.prototype,`fetchError`,void 0),M([m()],N.prototype,`lastTokenPriceUpdate`,void 0),N=M([h(`w3m-swap-view`)],N);var P=d`
  :host > wui-flex:first-child {
    overflow-y: auto;
    overflow-x: hidden;
    scrollbar-width: none;
...
`,F=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},I=class extends l{constructor(){super(),this.unsubscribe=[],this.detailsOpen=!0,this.approvalTransaction=_.state.approvalTransaction,this.swapTransaction=_.state.swapTransaction,this.sourceToken=_.state.sourceToken,this.sourceTokenAmount=_.state.sourceTokenAmount??``,this.sourceTokenPriceInUSD=_.state.sourceTokenPriceInUSD,this.balanceSymbol=o.getAccountData()?.balanceSymbol,this.toToken=_.state.toToken,this.toTokenAmount=_.state.toTokenAmount??``,this.toTokenPriceInUSD=_.state.toTokenPriceInUSD,this.caipNetwork=o.state.activeCaipNetwork,this.inputError=_.state.inputError,this.loadingQuote=_.state.loadingQuote,this.loadingApprovalTransaction=_.state.loadingApprovalTransaction,this.loadingBuildTransaction=_.state.loadingBuildTransaction,this.loadingTransaction=_.state.loadingTransaction,this.unsubscribe.push(o.subscribeChainProp(`accountState`,e=>{e?.balanceSymbol!==this.balanceSymbol&&r.goBack()}),o.subscribeKey(`activeCaipNetwork`,e=>{this.caipNetwork!==e&&(this.caipNetwork=e)}),_.subscribe(e=>{this.approvalTransaction=e.approvalTransaction,this.swapTransaction=e.swapTransaction,this.sourceToken=e.sourceToken,this.toToken=e.toToken,this.toTokenPriceInUSD=e.toTokenPriceInUSD,this.sourceTokenAmount=e.sourceTokenAmount??``,this.toTokenAmount=e.toTokenAmount??``,this.inputError=e.inputError,e.inputError&&r.goBack(),this.loadingQuote=e.loadingQuote,this.loadingApprovalTransaction=e.loadingApprovalTransaction,this.loadingBuildTransaction=e.loadingBuildTransaction,this.loadingTransaction=e.loadingTransaction}))}firstUpdated(){_.getTransaction(),this.refreshTransaction()}disconnectedCallback(){this.unsubscribe.forEach(e=>e?.()),clearInterval(this.interval)}render(){return u`
    ...
    `}templateDetails(){return!this.sourceToken||!this.toToken||this.inputError?null:u`<w3m-swap-details .detailsOpen=${this.detailsOpen}></w3m-swap-details>`}actionButtonLabel(){return this.loadingApprovalTransaction?`Approving...`:this.approvalTransaction?`Approve`:`Swap`}onCancelTransaction(){r.goBack()}onSendTransaction(){this.approvalTransaction?_.sendTransactionForApproval(this.approvalTransaction):_.sendTransactionForSwap(this.swapTransaction)}};I.styles=P,F([m()],I.prototype,`interval`,void 0),F([m()],I.prototype,`detailsOpen`,void 0),F([m()],I.prototype,`approvalTransaction`,void 0),F([m()],I.prototype,`swapTransaction`,void 0),F([m()],I.prototype,`sourceToken`,void 0),F([m()],I.prototype,`sourceTokenAmount`,void 0),F([m()],I.prototype,`sourceTokenPriceInUSD`,void 0),F([m()],I.prototype,`balanceSymbol`,void 0),F([m()],I.prototype,`toToken`,void 0),F([m()],I.prototype,`toTokenAmount`,void 0),F([m()],I.prototype,`toTokenPriceInUSD`,void 0),F([m()],I.prototype,`caipNetwork`,void 0),F([m()],I.prototype,`inputError`,void 0),F([m()],I.prototype,`loadingQuote`,void 0),F([m()],I.prototype,`loadingApprovalTransaction`,void 0),F([m()],I.prototype,`loadingBuildTransaction`,void 0),F([m()],I.prototype,`loadingTransaction`,void 0),I=F([h(`w3m-swap-preview-view`)],I);var L=d`
  :host {
    width: 100%;
    height: 60px;
    min-height: 60px;
...
`,R=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},z=class extends l{constructor(){super(),this.observer=new IntersectionObserver(()=>void 0),this.imageSrc=void 0,this.name=void 0,this.symbol=void 0,this.price=void 0,this.amount=void 0,this.visible=!1,this.imageError=!1,this.observer=new IntersectionObserver(e=>{e.forEach(e=>{this.visible=!!e.isIntersecting})},{threshold:.1})}firstUpdated(){this.observer.observe(this)}disconnectedCallback(){this.observer.disconnect()}render(){if(!this.visible)return null;let e=this.amount&&this.price?s.multiply(this.price,this.amount)?.toFixed(3):null;return u`
    ...
    `}visualTemplate(){return this.imageError?u`<wui-flex class="token-item-image-placeholder">
      ...
      ></wui-image>`:null}imageLoadError(){this.imageError=!0}};z.styles=[f,p,L],R([g()],z.prototype,`imageSrc`,void 0),R([g()],z.prototype,`name`,void 0),R([g()],z.prototype,`symbol`,void 0),R([g()],z.prototype,`price`,void 0),R([g()],z.prototype,`amount`,void 0),R([m()],z.prototype,`visible`,void 0),R([m()],z.prototype,`imageError`,void 0),z=R([h(`wui-token-list-item`)],z);var B=d`
  :host {
    width: 100%;
  }
...
`,V=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},H=class extends l{render(){return u`
      <wui-flex alignItems="center">
    ...
    `}};H.styles=[f,B],H=V([h(`wui-token-list-item-loader`)],H);var U=d`
  :host {
